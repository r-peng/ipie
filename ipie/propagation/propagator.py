...
from ipie.hamiltonians.sor_hf_trial import SORHFTrial
from ipie.hamiltonians.sor_hfb_trial import SORHFBTrial
...
Propagator = {
    ...
    SORHFTrial:PhaselessLin,
    SORHFBTrial:PhaselessLin,
}
